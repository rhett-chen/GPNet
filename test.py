...
parser.add_argument('--dataset_root', type=str, default='/data/wuchaozheng/dataset/shapenetSemGrasp/nips2020/new_9cls/',
...
parser.add_argument('--save_all', dest='save_all', default=False, help='whether save all prediction',
                    action='store_true')
