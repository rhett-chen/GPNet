...
def grasp_view(dmap, intrinsic, camera_ori, camera_pos, grasp_ori, grasp_center, grasp_length, pc=None):
    # rectify the grasp pose to camera pose. we need to ensure the camera z-axis orient to x-axis (the robot
    # gripper direction)
...
def grasp_view_pc(dmap, intrinsic, camera_ori, camera_pos, grasp_ori, grasp_center, grasp_length, pc, vis=False):
    # rectify the grasp pose to camera pose. we need to ensure the camera z-axis orient to x-axis
    # (the robot gripper direction)
